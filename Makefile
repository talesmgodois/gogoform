...
run-tasks: ## Run the pending tasks in __ai_work/tasks (optional: AGENT_CLI=opencode MAX_FIX_ATTEMPTS=3)
	$(if $(AGENT_CLI),AGENT_CLI=$(AGENT_CLI)) $(if $(MAX_FIX_ATTEMPTS),MAX_FIX_ATTEMPTS=$(MAX_FIX_ATTEMPTS)) python3 __ai_work/runner.py
